...
RSpec.describe ConfirmationRequest::AcceptsController, type: :controller do
  ...
  describe '#build_resource' do
    ...
    before { expect(ConfirmationRequest::Accept).to receive(:new).with(:parent).and_return(:resource) }
